...
- Deben tener una cuenta en **gitlab**
...
- De fallas en nuestro disco (podemos sincronizar nuestros cambios en la nube)
...
.texto-chico[Ciclos sucesivos de *modificar, poner en escena y confirmar* van generando el historial de cambios de nuestro repositorio]

--

.texto-chico[Cada _commit_ es una foto del estado de nuestros archivos a la que podemos acceder cuando queramos]

--

- .texto-chico[**NO** podemos acceder a estados intermedios entre dos _commit_]

--

- .texto-chico[Queremos hacer _commit_ frecuentemente y con un número de cambios manejable]

--

.texto-chico[Si quiero trabajar de manera individual, no necesito más que lo que hemos visto hasta ahora]

--

.center[
<img src="https://i.gifer.com/2DAN.gif" width="200" />
]



.texto-chico[Los commit nos permiten sujetarnos a la roca] 

--

.texto-chico[En terreno peligroso, es mejor hacer más commits.]  

--

.texto-chico[Si nos caemos, tendremos un punto del cual sujetarnos]
...
.texto-chico[La rama principal se llama `main` o `master` y aloja la versión oficial de nuestro proyecto, pero podemos crear tantas como queramos]
---
template:diapo-basica
...
.texto-chico[Cuando trabajamos con repositorios remotos, muchas veces existen archivos que queremos mantener solo en nuestro computador o que no son realmente compatibles con un repositorio git, por lo que no queremos subirlos a la nube:]
...
.texto-chico[Estos los anotamos en el archivo .gitignore, que es un archivo de texto simple.]

--

.texto-chico[**Importante:** .gitignore tiene algunas notaciones particulares, pero lo más relevante es que  el * sirve como comodín]

.texto-chico[**Nota**: pueden crear un .gitignore fácilmente generando un archivo de texto y poniéndole de nombre ".gitignore". 
Es importante que su nombre .red[NO tenga extensión] (por ejemplo .txt).]
...
**git status**: muestra estado actual de los archivos que están en un estado distinto al que tenían antes
del último commit.
...
[Clase online de git para usuarios de R](https://www.youtube.com/watch?v=S-PzhB_-FKc&list=PL9bSrHSohaeGBih-_5o0KOBHrAzyiD0OW&index=5)
